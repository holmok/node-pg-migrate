...
const createSchemalize = (shouldDecamelize, shouldQuote) => {
  const transform = [
    shouldDecamelize ? decamelize_1.default : identity,
...
const getMigrationTableSchema = (options) =>
  options.migrationsSchema !== undefined ? options.migrationsSchema : exports.getSchemas(options.schema)[0]
...
const applyType = (type, extendingTypeShorthands = {}) => {
  ...
  while (typeShorthands[types[types.length - 1]]) {
    ext = Object.assign(
      Object.assign({}, toType(typeShorthands[types[types.length - 1]])),
  ...
  return Object.assign(Object.assign(Object.assign({}, ext), options), {
    type: exports.applyTypeAdapters(
      (_a = ext === null || ext === void 0 ? void 0 : ext.type) !== null && _a !== void 0 ? _a : options.type,
    ),
  })
}
